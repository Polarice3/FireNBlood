...
public class SpearEntity extends AbstractArrowEntity {
    ...
    private ItemStack tridentItem = new ItemStack(RegistryHandler.IRON_SPEAR.get());
    ...
    public void setTridentItem(IItemTier tier){
        if (tier == ItemTier.WOOD){
            this.tridentItem = new ItemStack(RegistryHandler.WOODEN_SPEAR.get());
        } else if (tier == ItemTier.STONE){
            this.tridentItem = new ItemStack(RegistryHandler.STONE_SPEAR.get());
        } else if (tier == ItemTier.IRON){
            this.tridentItem = new ItemStack(RegistryHandler.IRON_SPEAR.get());
        } else if (tier == ItemTier.DIAMOND){
            this.tridentItem = new ItemStack(RegistryHandler.DIAMOND_SPEAR.get());
        } else if (tier == ItemTier.NETHERITE){
            this.tridentItem = new ItemStack(RegistryHandler.NETHERITE_SPEAR.get());
        } else {
            this.tridentItem = new ItemStack(RegistryHandler.IRON_SPEAR.get());
        }
    }
