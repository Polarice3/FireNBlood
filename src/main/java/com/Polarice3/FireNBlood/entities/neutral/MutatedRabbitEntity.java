...
public class MutatedRabbitEntity extends MutatedEntity {
    ...
    public MutatedRabbitEntity(EntityType<? extends MutatedEntity> type, World worldIn) {
        super(type, worldIn);
        this.jumpControl = new MutatedRabbitEntity.JumpHelperController(this);
        this.moveControl = new MutatedRabbitEntity.MoveHelperController(this);
        this.setSpeedModifier(0.0D);
    }

    protected void registerGoals() {
        this.goalSelector.addGoal(1, new SwimGoal(this));
        this.goalSelector.addGoal(4, new MutatedRabbitEntity.EvilAttackGoal(this));
        this.goalSelector.addGoal(5, new MutatedRabbitEntity.RaidFarmGoal(this));
    ...
    public void customServerAiStep() {
        ...
        this.setSpread(pop.size() <= FNBConfig.MRabbitMax.get());
        ...
        if (this.onGround) {
            ...
            MutatedRabbitEntity.JumpHelperController rabbitentity$jumphelpercontroller = (MutatedRabbitEntity.JumpHelperController)this.jumpControl;
    ...
    private void enableJumpControl() {
        ((MutatedRabbitEntity.JumpHelperController)this.jumpControl).setCanJump(true);
    }

    private void disableJumpControl() {
        ((MutatedRabbitEntity.JumpHelperController)this.jumpControl).setCanJump(false);
    }
    ...
    static class MoveHelperController extends MovementController {
        ...
        public void tick() {
            if (this.rabbit.onGround && !this.rabbit.jumping && !((MutatedRabbitEntity.JumpHelperController)this.rabbit.jumpControl).wantJump()) {
