...
public class TaillessMeleeGoal extends Goal {
    ...
    public TaillessMeleeGoal(CreatureEntity creature, double speedIn, boolean useLongMemory) {
        this.attacker = creature;
        this.speedTowardsTarget = speedIn;
        this.longMemory = useLongMemory;
        this.setMutexFlags(EnumSet.of(Goal.Flag.MOVE, Goal.Flag.LOOK));
        this.attackspeed = this.attacker.getBaseAttributeValue(Attributes.ATTACK_SPEED);
    }
