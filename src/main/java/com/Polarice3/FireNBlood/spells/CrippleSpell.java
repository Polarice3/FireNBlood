...
public class CrippleSpell extends Spells{
    ...
    public void WandResult(World worldIn, LivingEntity entityLiving) {
        ...
        for(int i = 0; i < 40; ++i) {
            ...
            new ParticleUtil(ParticleTypes.WITCH, vector3d.x, vector3d.y, vector3d.z, d0, d1, d2);
        }
        ...
        for(int i = 0; i < entityLiving.level.random.nextInt(35) + 10; ++i) {
            new ParticleUtil(ParticleTypes.DRAGON_BREATH, entityLiving.getX(), entityLiving.getEyeY(), entityLiving.getZ(), 0.0F, 0.0F, 0.0F);
        }
    }
