...
public class TaillessDruidModel<T extends TaillessDruidEntity> extends EntityModel<T> {
    private final ModelRenderer BullMan;
    private final ModelRenderer Body;
    private final ModelRenderer BodyChest_r1;
    private final ModelRenderer Robe;
    private final ModelRenderer BodyChest_r2;
    private final ModelRenderer LowerRobe;
    ...
    public TaillessDruidModel(float f) {
        texWidth = 64;
        texHeight = 64;
        ...
        BodyChest_r2 = new ModelRenderer(this);
        BodyChest_r2.setPos(0.0F, -0.8447F, -0.7471F);
        Robe.addChild(BodyChest_r2);
        setRotationAngle(BodyChest_r2, 0.2618F, 0.0F, 0.0F);
        BodyChest_r2.texOffs(36, 36).addBox(-4.0F, -4.0F, -2.5F, 8.0F, 5.0F, 6.0F, 0.0F, false);

        LowerRobe = new ModelRenderer(this);
        LowerRobe.setPos(0.0F, 0.0F, 0.0F);
        Robe.addChild(LowerRobe);


        cube_r1 = new ModelRenderer(this);
        cube_r1.setPos(0.0F, 0.0F, 0.0F);
        LowerRobe.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.4363F, 0.0F, 0.0F);
        cube_r1.texOffs(41, 5).addBox(-2.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, 0.0F, false);

        cube_r2 = new ModelRenderer(this);
        cube_r2.setPos(0.0F, 0.0F, 0.0F);
        LowerRobe.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.0F, 0.0F, -0.4363F);
        cube_r2.texOffs(56, 10).addBox(0.0F, 4.0F, -1.0F, 1.0F, 4.0F, 3.0F, 0.0F, false);

        cube_r3 = new ModelRenderer(this);
        cube_r3.setPos(0.0F, 0.0F, 0.0F);
        LowerRobe.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.0F, 0.0F, 0.4363F);
        cube_r3.texOffs(41, 10).addBox(-1.0F, 4.0F, -1.0F, 1.0F, 4.0F, 3.0F, 0.0F, false);

        cube_r4 = new ModelRenderer(this);
        cube_r4.setPos(0.0F, 0.0F, 0.0F);
        LowerRobe.addChild(cube_r4);
        setRotationAngle(cube_r4, -0.4363F, 0.0F, 0.0F);
        cube_r4.texOffs(50, 12).addBox(-1.0F, 4.0F, 0.0F, 2.0F, 4.0F, 1.0F, 0.0F, false);
        ...
        Staff.setPos(-0.5F, 7.6282F, -6.1219F);
        RArmParts.addChild(Staff);


        cube_r5 = new ModelRenderer(this);
        cube_r5.setPos(-0.5F, -0.7765F, -2.8978F);
        Staff.addChild(cube_r5);
        setRotationAngle(cube_r5, 1.309F, 0.0F, 0.0F);
        cube_r5.texOffs(52, 4).addBox(-1.5F, -3.5F, -1.5F, 3.0F, 3.0F, 3.0F, 0.0F, false);

        cube_r6 = new ModelRenderer(this);
        cube_r6.setPos(-1.0F, 1.8718F, 3.1219F);
        Staff.addChild(cube_r6);
        setRotationAngle(cube_r6, -0.2618F, 0.0F, 0.0F);
        cube_r6.texOffs(0, 38).addBox(0.0F, -1.5F, -9.0F, 1.0F, 1.0F, 18.0F, 0.0F, false);

        RArmRobe = new ModelRenderer(this);
        RArmRobe.setPos(0.0F, -2.0F, 0.0F);
        RArmParts.addChild(RArmRobe);
        RArmRobe.texOffs(52, 29).addBox(-3.0F, 0.0F, -2.0F, 3.0F, 4.0F, 3.0F, 0.0F, false);
        ...
        LArmRobe = new ModelRenderer(this);
        LArmRobe.setPos(-7.0F, -2.0F, 0.0F);
        LArmParts.addChild(LArmRobe);
        LArmRobe.texOffs(37, 29).addBox(7.0F, 0.0F, -2.0F, 3.0F, 4.0F, 3.0F, 0.0F, false);
        ...
        cube_r7.setPos(0.519F, -0.1981F, -0.3415F);
        lefthorns.addChild(cube_r7);
        setRotationAngle(cube_r7, 0.0F, 1.0472F, -0.5672F);
        cube_r7.texOffs(32, 0).addBox(-1.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

        cube_r8 = new ModelRenderer(this);
        cube_r8.setPos(-0.519F, 0.1981F, 0.3415F);
        lefthorns.addChild(cube_r8);
        setRotationAngle(cube_r8, 0.0F, 0.0F, -0.3927F);
        cube_r8.texOffs(25, 18).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
        ...
        cube_r9.setPos(-0.519F, -0.1981F, -0.3415F);
        righthorns.addChild(cube_r9);
        setRotationAngle(cube_r9, 0.0F, -1.0472F, 0.5672F);
        cube_r9.texOffs(17, 9).addBox(-1.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);

        cube_r10 = new ModelRenderer(this);
        cube_r10.setPos(0.519F, 0.1981F, 0.3415F);
        righthorns.addChild(cube_r10);
        setRotationAngle(cube_r10, 0.0F, 0.0F, 0.3927F);
        cube_r10.texOffs(7, 24).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);
    }
