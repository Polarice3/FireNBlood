...
public class BulldrakeModel extends SegmentedModel<TaillessHorrorEntity> {
    ...
    public BulldrakeModel() {
        ...
        Bulldrake.setPos(0.0F, 16.0F, 2.0F);
        ...
        Body.texOffs(78, 54).addBox(-4.0F, 4.0F, -2.0001F, 8.0F, 4.0F, 6.0F, 0.0F, false);
        Body.texOffs(45, 61).addBox(-6.0F, -4.0F, -4.0001F, 12.0F, 8.0F, 8.0F, 0.0F, false);
        Body.texOffs(0, 0).addBox(-8.0F, -12.0F, -6.0001F, 16.0F, 8.0F, 10.0F, 0.0F, false);
        Body.texOffs(29, 78).addBox(-4.0F, 8.0F, -4.0001F, 8.0F, 6.0F, 8.0F, 0.0F, false);

        RLegParts = new ModelRenderer(this);
        RLegParts.setPos(-4.0F, 0.0F, 11.0F);
        ...
        RThigh.texOffs(62, 83).addBox(-4.0F, -5.0F, -3.0F, 4.0F, 8.0F, 6.0F, 0.0F, false);

        RKnee = new ModelRenderer(this);
        RKnee.setPos(-1.0F, 8.0F, -3.0F);
        RLegParts.addChild(RKnee);
        setRotationAngle(RKnee, -0.2618F, 0.0F, 0.0F);
        RKnee.texOffs(17, 93).addBox(-3.0F, -4.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);

        RLeg = new ModelRenderer(this);
        RLeg.setPos(-1.0F, 14.0F, -3.0F);
        RLegParts.addChild(RLeg);
        RLeg.texOffs(47, 93).addBox(-3.0F, -4.0F, -1.0F, 4.0F, 6.0F, 2.0F, 0.0F, false);

        RFoot = new ModelRenderer(this);
        RFoot.setPos(-1.0F, 18.0F, -4.0F);
        RLegParts.addChild(RFoot);
        setRotationAngle(RFoot, 0.4363F, 0.0F, 0.0F);
        RFoot.texOffs(86, 65).addBox(-3.0F, -1.0F, -3.0F, 4.0F, 2.0F, 6.0F, 0.0F, false);

        LLegParts = new ModelRenderer(this);
        LLegParts.setPos(6.0F, 0.0F, 13.0F);
        ...
        LThigh.texOffs(0, 81).addBox(0.0F, -5.0F, -3.0F, 4.0F, 8.0F, 6.0F, 0.0F, false);

        LKnee = new ModelRenderer(this);
        LKnee.setPos(1.0F, 6.0F, -3.0F);
        LLegParts.addChild(LKnee);
        setRotationAngle(LKnee, -0.2618F, 0.0F, 0.0F);
        LKnee.texOffs(83, 92).addBox(-3.0F, -4.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);

        LLeg = new ModelRenderer(this);
        LLeg.setPos(1.0F, 12.0F, -3.0F);
        LLegParts.addChild(LLeg);
        LLeg.texOffs(34, 93).addBox(-3.0F, -4.0F, -1.0F, 4.0F, 6.0F, 2.0F, 0.0F, false);

        LFoot = new ModelRenderer(this);
        LFoot.setPos(1.0F, 16.0F, -4.0F);
        LLegParts.addChild(LFoot);
        setRotationAngle(LFoot, 0.4363F, 0.0F, 0.0F);
        LFoot.texOffs(83, 83).addBox(-3.0F, -1.0F, -3.0F, 4.0F, 2.0F, 6.0F, 0.0F, false);

        HeadParts = new ModelRenderer(this);
        HeadParts.setPos(0.3333F, 1.5F, -11.3333F);
        ...
        Head_r1.texOffs(0, 66).addBox(-6.0F, -4.0F, -6.0F, 10.0F, 6.0F, 8.0F, 0.0F, false);

        JawUp = new ModelRenderer(this);
        JawUp.setPos(0.6667F, -0.5F, -0.6667F);
        HeadParts.addChild(JawUp);
        JawUp.texOffs(0, 39).addBox(-6.0F, -3.0F, -10.0F, 10.0F, 5.0F, 12.0F, 0.0F, false);
        JawUp.texOffs(0, 110).addBox(-6.0F, -3.0F, -10.0F, 10.0F, 4.0F, 10.0F, 0.0F, false);

        JawDown = new ModelRenderer(this);
        JawDown.setPos(0.6667F, 2.5F, -0.6667F);
        HeadParts.addChild(JawDown);
        JawDown.texOffs(33, 45).addBox(-6.0F, -3.0F, -10.0F, 10.0F, 3.0F, 12.0F, 0.0F, false);
        ...
        REar_r1.texOffs(98, 3).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);
        ...
        LEar_r1.texOffs(33, 44).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);

        RHorns = new ModelRenderer(this);
        RHorns.setPos(2.6667F, 46.5F, -6.6667F);
        HeadParts.addChild(RHorns);


        RHorn2_r1 = new ModelRenderer(this);
        RHorn2_r1.setPos(-11.0F, -52.0F, 5.0F);
        RHorns.addChild(RHorn2_r1);
        RHorn2_r1.texOffs(0, 96).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F, false);

        RHorn1_r1 = new ModelRenderer(this);
        RHorn1_r1.setPos(-12.0F, -49.5F, 5.0F);
        RHorns.addChild(RHorn1_r1);
        RHorn1_r1.texOffs(95, 74).addBox(2.0F, -5.5F, -1.0F, 2.0F, 6.0F, 2.0F, 0.0F, false);

        LHorns = new ModelRenderer(this);
        LHorns.setPos(2.6667F, 46.5F, -6.6667F);
        ...
        LHorn2_r1.texOffs(0, 39).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F, false);

        LHorn1_r1 = new ModelRenderer(this);
        LHorn1_r1.setPos(3.0F, -49.5F, 5.0F);
        LHorns.addChild(LHorn1_r1);
        LHorn1_r1.texOffs(0, 0).addBox(-1.0F, -5.5F, -1.0F, 2.0F, 6.0F, 2.0F, 0.0F, false);

        RWing = new ModelRenderer(this);
        RWing.setPos(-7.0F, 1.0F, -9.0F);
        Bulldrake.addChild(RWing);
        RWing.texOffs(0, 24).addBox(-31.0F, -1.0F, -3.0F, 30.0F, 2.0F, 2.0F, 0.0F, false);
        RWing.texOffs(0, 34).addBox(-29.0F, -1.0F, -1.0F, 28.0F, 2.0F, 2.0F, 0.0F, false);
        RWing.texOffs(43, 0).addBox(-27.0F, -1.0F, 1.0F, 26.0F, 2.0F, 2.0F, 0.0F, false);
        RWing.texOffs(61, 29).addBox(-25.0F, -1.0F, 3.0F, 24.0F, 2.0F, 2.0F, 0.0F, false);
        RWing.texOffs(0, 61).addBox(-23.0F, -1.0F, 5.0F, 24.0F, 2.0F, 2.0F, 0.0F, false);
        RWing.texOffs(61, 34).addBox(-21.0F, -1.0F, 7.0F, 22.0F, 2.0F, 2.0F, 0.0F, false);
        RWing.texOffs(65, 20).addBox(-19.0F, -1.0F, 9.0F, 20.0F, 2.0F, 2.0F, 0.0F, false);
        RWing.texOffs(66, 49).addBox(-17.0F, -1.0F, 11.0F, 18.0F, 2.0F, 2.0F, 0.0F, false);

        LWing = new ModelRenderer(this);
        LWing.setPos(7.0F, 1.0F, -9.0F);
        Bulldrake.addChild(LWing);
        LWing.texOffs(0, 19).addBox(1.0F, -1.0F, -3.0F, 30.0F, 2.0F, 2.0F, 0.0F, false);
        LWing.texOffs(0, 29).addBox(1.0F, -1.0F, -1.0F, 28.0F, 2.0F, 2.0F, 0.0F, false);
        LWing.texOffs(33, 39).addBox(1.0F, -1.0F, 1.0F, 26.0F, 2.0F, 2.0F, 0.0F, false);
        LWing.texOffs(53, 10).addBox(1.0F, -1.0F, 3.0F, 24.0F, 2.0F, 2.0F, 0.0F, false);
        LWing.texOffs(43, 5).addBox(-1.0F, -1.0F, 5.0F, 24.0F, 2.0F, 2.0F, 0.0F, false);
        LWing.texOffs(63, 15).addBox(-1.0F, -1.0F, 7.0F, 22.0F, 2.0F, 2.0F, 0.0F, false);
        LWing.texOffs(66, 44).addBox(-1.0F, -1.0F, 9.0F, 20.0F, 2.0F, 2.0F, 0.0F, false);
        LWing.texOffs(54, 78).addBox(-1.0F, -1.0F, 11.0F, 18.0F, 2.0F, 2.0F, 0.0F, false);

        Arrows = new ModelRenderer(this);
        Arrows.setPos(0.0F, -5.0F, -6.0F);
        Bulldrake.addChild(Arrows);


        cube_r1 = new ModelRenderer(this);
        cube_r1.setPos(-0.5F, -1.0F, 1.5F);
        Arrows.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.0F, 0.0F, 0.3927F);
        cube_r1.texOffs(9, 96).addBox(2.5F, -11.0F, -1.5F, 1.0F, 12.0F, 1.0F, 0.0F, false);

        cube_r2 = new ModelRenderer(this);
        cube_r2.setPos(-0.5F, -2.0F, 1.5F);
        Arrows.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.48F, 0.0F, 0.7854F);
        cube_r2.texOffs(65, 98).addBox(2.5F, -8.0F, -4.5F, 1.0F, 8.0F, 1.0F, 0.0F, false);

        cube_r3 = new ModelRenderer(this);
        cube_r3.setPos(-0.5F, -2.0F, 1.5F);
        Arrows.addChild(cube_r3);
        setRotationAngle(cube_r3, -0.4363F, 0.0F, 0.7854F);
        cube_r3.texOffs(37, 66).addBox(2.5F, -9.0F, 1.5F, 1.0F, 10.0F, 1.0F, 0.0F, false);

        cube_r4 = new ModelRenderer(this);
        cube_r4.setPos(-4.0F, -2.0F, -2.0F);
        Arrows.addChild(cube_r4);
        setRotationAngle(cube_r4, 0.3927F, 0.0F, -0.6981F);
        cube_r4.texOffs(60, 98).addBox(-1.0F, -4.0F, -2.0F, 1.0F, 8.0F, 1.0F, 0.0F, false);

        cube_r5 = new ModelRenderer(this);
        cube_r5.setPos(-0.5F, -2.0F, 1.5F);
        Arrows.addChild(cube_r5);
        setRotationAngle(cube_r5, 0.0F, 0.0F, -0.4363F);
        cube_r5.texOffs(21, 81).addBox(-3.5F, -7.0F, -0.5F, 1.0F, 10.0F, 1.0F, 0.0F, false);
    }
