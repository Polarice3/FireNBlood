...
import com.Polarice3.FireNBlood.client.model.WitchGaleModel;
import com.Polarice3.FireNBlood.entities.projectiles.WitchGaleEntity;
...
public class WitchGaleRenderer extends EntityRenderer<WitchGaleEntity> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(FireNBlood.MOD_ID,"textures/entity/cripplegust.png");
