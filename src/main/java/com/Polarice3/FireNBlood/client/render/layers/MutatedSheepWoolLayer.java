...
import com.Polarice3.FireNBlood.client.model.MutatedSheepWoolModel;
...
public class MutatedSheepWoolLayer extends LayerRenderer<MutatedSheepEntity, MutatedSheepModel<MutatedSheepEntity>> {
    private static final ResourceLocation SHEEP_FUR_LOCATION = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/mutatedsheepwool.png");
