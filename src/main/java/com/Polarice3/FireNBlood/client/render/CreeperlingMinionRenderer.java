...
import com.Polarice3.FireNBlood.client.render.layers.CreeperlingChargeLayer;
...
public class CreeperlingMinionRenderer extends MobRenderer<CreeperlingMinionEntity, SpiderModel<CreeperlingMinionEntity>> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/creeperling.png");
