...
@OnlyIn(Dist.CLIENT)
public class ScorchBallRenderer extends EntityRenderer<ScorchBallEntity> {
    ...
    public ScorchBallRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    protected int getBlockLight(ScorchBallEntity entityIn, BlockPos partialTicks) {
        return 15;
    }

    public void render(ScorchBallEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
     ...
     */
    public ResourceLocation getEntityTexture(ScorchBallEntity entity) {
        return TEXTURE;
    }
}
