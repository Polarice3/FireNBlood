...
import com.Polarice3.FireNBlood.client.model.MutatedPigModel;
...
public class MutatedPigRenderer extends MobRenderer<MutatedPigEntity, MutatedPigModel<MutatedPigEntity>> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/mutatedpig.png");
