...
import com.Polarice3.FireNBlood.client.model.SpearModel;
...
public class SpearRenderer extends EntityRenderer<SpearEntity> {
    public static final ResourceLocation WOODEN_SPEAR = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/wooden_spear.png");
    public static final ResourceLocation STONE_SPEAR = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/stone_spear.png");
    public static final ResourceLocation IRON_SPEAR = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/iron_spear.png");
    public static final ResourceLocation DIAMOND_SPEAR = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/diamond_spear.png");
    public static final ResourceLocation NETHERITE_SPEAR = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/netherite_spear.png");
