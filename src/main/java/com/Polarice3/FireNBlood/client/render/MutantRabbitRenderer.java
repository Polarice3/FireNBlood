...
import com.Polarice3.FireNBlood.client.model.MutantRabbitModel;
...
public class MutantRabbitRenderer extends MobRenderer<MutatedRabbitEntity, MutantRabbitModel<MutatedRabbitEntity>> {
    private static final ResourceLocation RABBIT_BROWN_LOCATION = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/mutatedrabbit_brown.png");
    private static final ResourceLocation RABBIT_WHITE_LOCATION = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/mutatedrabbit_white.png");
    private static final ResourceLocation RABBIT_BLACK_LOCATION = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/mutatedrabbit_black.png");
    private static final ResourceLocation RABBIT_GOLD_LOCATION = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/mutatedrabbit_gold.png");
    private static final ResourceLocation RABBIT_SALT_LOCATION = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/mutatedrabbit_salt.png");
    private static final ResourceLocation RABBIT_WHITE_SPLOTCHED_LOCATION = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/mutatedrabbit_splotched.png");
