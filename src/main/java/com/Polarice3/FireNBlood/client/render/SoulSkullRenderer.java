...
public class SoulSkullRenderer extends EntityRenderer<SoulSkullEntity> {
    private static final ResourceLocation WITHER_INVULNERABLE_LOCATION = new ResourceLocation(FireNBlood.MOD_ID,"textures/entity/soulskull_destroy.png");
    private static final ResourceLocation WITHER_LOCATION = new ResourceLocation(FireNBlood.MOD_ID,"textures/entity/soulskull.png");
