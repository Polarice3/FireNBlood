...
import com.Polarice3.FireNBlood.client.model.SacredFishModel;
import com.Polarice3.FireNBlood.entities.neutral.SacredFishEntity;
...
public class SacredFishRenderer extends MobRenderer<SacredFishEntity, SacredFishModel> {
    protected static final ResourceLocation TEXTURE = new ResourceLocation(FireNBlood.MOD_ID, "textures/entity/sacredfish.png");
